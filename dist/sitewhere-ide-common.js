...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('vue'), require('moment'), require('vue-property-decorator')) :
    typeof define === 'function' && define.amd ? define(['exports', 'vue', 'moment', 'vue-property-decorator'], factory) :
    (global = global || self, factory(global.SiteWhereIdeCommon = {}, global.Vue, global.moment, global.vuePropertyDecorator));
}(this, function (exports, Vue, moment, vuePropertyDecorator) { 'use strict';
