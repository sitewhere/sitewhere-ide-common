...
function listInstancePipelineLogEntries(store, tenantToken, criteria, format) {
    var axios = createCoreApiCall(store);
    var api = API.Instance.listInstancePipelineLogEntries(axios, tenantToken, criteria, format);
    return loaderWrapper(store, api);
}
/**
...
function deleteInstancePipelineLogEntries(store, tenantToken) {
    var axios = createCoreApiCall(store);
    var api = API.Instance.deleteInstancePipelineLogEntries(axios, tenantToken);
    return loaderWrapper(store, api);
}
...
function listRoles(store, criteria, format) {
    var axios = createCoreApiCall(store);
    var api = API.Users.listRoles(axios, criteria, format);
    return loaderWrapper(store, api);
}
