...
export function listScriptCategories(
  ...
  let api: AxiosPromise<
    IScriptCategory[]
  > = API.Scripting.listScriptCategories(axios, identifier);
...
export function listScriptTemplates(
  ...
  let api: AxiosPromise<
    IScriptTemplate[]
  > = API.Scripting.listScriptTemplates(axios, identifier, category);
  return loaderWrapper(store, api);
}
...
export function listTenantScriptMetadata(
  ...
  let api: AxiosPromise<
    IScriptMetadata[]
  > = API.Scripting.listTenantScripts(axios, identifier, tenantToken);
  return loaderWrapper(store, api);
}
...
export function listTenantScriptsForCategory(
  ...
  let api: AxiosPromise<
    IScriptMetadata[]
  > = API.Scripting.listTenantScriptsForCategory(
    axios,
    identifier,
    tenantToken,
    category
...
export function listTenantScriptsByCategory(
  ...
  let api: AxiosPromise<
    IScriptCategory[]
  > = API.Scripting.listTenantScriptsByCategory(
    axios,
    identifier,
    tenantToken
  );
...
export function createTenantScript(
  ...
  let api: AxiosPromise<
    IScriptMetadata
  > = API.Scripting.createTenantScript(
    axios,
    identifier,
    tenantToken,
    request
...
export function getTenantScriptContent(
  ...
  let api: AxiosPromise<
    string
  > = API.Scripting.getTenantScriptContent(
    axios,
    identifier,
    tenantToken,
    scriptId,
...
export function updateTenantScript(
  ...
  let api: AxiosPromise<
    IScriptMetadata
  > = API.Scripting.updateTenantScript(
    axios,
    identifier,
    tenantToken,
    scriptId,
...
export function cloneTenantScript(
  ...
  let api: AxiosPromise<
    IScriptVersion
  > = API.Scripting.cloneTenantScript(
    axios,
    identifier,
    tenantToken,
    scriptId,
...
export function activateTenantScript(
  ...
  let api: AxiosPromise<
    IScriptMetadata
  > = API.Scripting.activateTenantScript(
    axios,
    identifier,
    tenantToken,
    scriptId,
